<div class="border-l-4 border-[#F96D00] bg-lightGray w-full p-6 text-sm md:text-lg">
    <div class="flex flex-col sm:flex-row items-center justify-between">
        <img src="/gambar/company-logo.png" class="w-56" alt="" />
        <button
            id="like"
            class="like-bold-button self-end sm:self-center hidden"
        >
        <svg
        ...
        <button
        id="fill"
        class="like-fill-button self-end sm:self-center"
        >
            <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
    ...
    <a href="#" class="font-semibold">Nama Pekerjaan</a>
    <p>Nama Perusahaan</p>
    <p>Tempat Kerja</p>
</div>